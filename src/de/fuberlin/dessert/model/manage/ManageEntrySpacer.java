...
public class ManageEntrySpacer extends ManageEntry {

    public ManageEntrySpacer(String description) {
        super(description);
    }

    @Override
    public ManageEntryType getType() {
        return ManageEntryType.SPACER;
    }
    ...
    public View getView(LayoutInflater layoutInflater, View convertView, ViewGroup parent) {
        ...
        View view;
        if (convertView == null) {
            view = layoutInflater.inflate(R.layout.manage_spacer_element, parent, false);
        } else {
            view = convertView;
        }
